...
public class JavascriptUtils {
    ...
    public static void clickElementByJS(WebDriver driver,WebElement element) {
        JavascriptExecutor jsexecutor = ((JavascriptExecutor) driver);   // click lemek te sikinti cekilen elemente click yapar
        jsexecutor.executeScript("arguments[0].click();", element);  // elementin 8 locator türünden biri ile
    }

    //to get the page title with JS-(JS ile sayfa başlığını almak için)
    ...
    //Scrolling all the way down  (****sayfayi Tamamen aşağı kaydırılıyor)****************
    ...
    //Scroll into view with JS. THIS IS VERY USEFULL  //****bir elemente kadar KAYDIR Scroll****************
    ...
    //Flashing the background color //Arka plan renginin yanıp sönmesi
    ...
    //this will generate an alert when needed //istendiginde bir uyarı oluşturma
     ...
     * verilen web öğesinde verilen JavaScript komutunu çalıştırır
     */
